...
class HomeTabAdapter(val context: Context, private val Menu: List<Food>) : RecyclerView.Adapter<HomeTabAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.list_recycle_home, parent, false)
